  ...
  window.EZQuiz = {
    ...
    // ends the quiz
      ...
      var timer = document.getElementById('quiz-timer'),
          wrong = 'Yanlış yanıtlarınız <span class="t-red"> KIRMIZI </span> renk ile çerçevelenmiştir. Doğru yanıtlarınız ise <span class="t-blue"> MAVİ </span> renk ile çerçevelenmiştir.';
      ...
      '<div id="result-list">'+
        ...
        '<div class="result-row center">'+
          ( // depending on the score, a specific message will show
            EZQuiz.stats.score == 100 ? 'En Yüksek Puanı Aldınız. Tebrikler ' :
            EZQuiz.stats.score > 70 ? 'Güzel Puan! ' + wrong :
            'Çalışmaya Devam Etmelisin! ' + wrong
          )+
          '<div class="center">'+
            '<a href="./' + EZQuiz.local + '" class="button">Tekrarla</a>'+
            '<a href="' + document.getElementById('home-link').href + '" class="button">Ana Sayfa</a>'+
          '</div>'+
        '</div>'+
      '</div>';
